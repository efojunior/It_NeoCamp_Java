...
<div align="center"><img src="https://i.imgur.com/otSIUD5.png" title="source: imgur.com" /></div>
...
Nas imagens abaixo podemos visualizar a hierarquia dos modificadores:

<div align="center"><img src="https://i.imgur.com/NdEp3gV.png" title="source: imgur.com" /></div>

A imagem acima mostra o nível de visibilidade de um Atributo e Método, do nível de acesso mais restrito (Private) ao nível de acesso total e irrestrito (Public). Na tabela abaixo temos um resumo:
...
| <img src="https://i.imgur.com/hOgWvSc.png" title="source: imgur.com" width="80px"/> | <div align="left"> **ATENÇÃO:** *Modificadores de acesso de um Atributo definem quais Classes poderão acessar o Atributo, da mesma forma que os Modificadores de acesso de um Método definem quais Classes terão acesso ao Método.* </div> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |

**Exemplo - Classe Conta com os respectivos Atributos e modificadores:**
...
Para criar (instanciar) um novo Objeto de uma Classe, precisamos implementar uma Método para gerar este novo Objeto. O Método responsável por esta tarefa em uma Classe é o **Método Construtor**. 
...
- Usando o mecanismo de Sobrecarga (Já falaremos sobre este assunto), mais de um construtor pode ser definido para oferecer diversas maneiras de inicializar os objetos dessa classe. 
...
Graças a Sobrecarga de Métodos é possível ter várias versões de um Método recebendo diferentes tipos de parâmetros. Você pode aplicar a Sobrecarga em qualquer Método da sua Classe, exceto o Main.
...
Para instanciar Objetos da Classe Conta, nós utilizaremos uma outra Classe chamada Menu, que futuramente será o Menu da aplicação. Nesta Classe nós iremos implementar um velho conhecido de vocês: O Método Main()!
