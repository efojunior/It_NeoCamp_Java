...
| <img src="https://i.imgur.com/hOgWvSc.png" title="source: imgur.com" width="80px"/> | <div align="left"> **ATENÇÃO:** Este material foi desenvolvido em cima da versão 17 do Java, que é aultima versão LTS (Oficial com longo tempo de suporte).</div> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
