...
| M      | mês do ano             | Número       | 7; 07; Jul; July; J |
| L      | mês do ano por extenso | Texto        |                     |
| Y      | ano                    | Número       |                     |
| E      | dia da semana          | Texto        | Tue; Tuesday; T     |
| a      | AM PM                  | Texto        | PM                  |
| h      | hora (1-12)            | Número       | 12                  |
| k      | hora (1-24)            | Número       | 24                  |
| m      | minutos                | Número       | 30                  |
| s      | segundos               | Número       | 55                  |
| n      | milisegundos           | Número       | 987654321           |
...
| <img src="https://i.imgur.com/vVDBDG0.png" title="source: imgur.com" width="200px"/> | <div align="left"> **ALERTA DE BSM:** *Mantenha a Atenção aos Detalhes ao trabalhar com as Classes Period e Duration. As Classes Classes Period e Duration não aceitam Objetos da Classe LocalDateTime.* </div> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
