...
public class Menu {
	...
	public static void main(String[] args) {
        ...
        c1.visualiza();
       	...
       	Conta c2 = new Conta(123456, "123", "CC", "João da Silva", 2000.0f);
	    c2.visualiza();
...
- O segundo sem os parâmetros, mas com os Atributos preenchidos.
...
```java
package com.generation.conta_poo.model;
